...
from R_EA import train_and_eval, random_architecture_func, get_final_accuracy, get_num_classes, mutate_arch_func
...
def main(xargs, nas_bench, gs_api):
    ...
    while total_costs < xargs.time_budget:
        ...
        for i in range(10):
            ...
            arch_id = nas_bench.query_index_by_arch(arch_cand)
